...
%        \left\{
%        \begin{aligned}
%        (\Omega_{p},\alpha_{p})  &\Longrightarrow |H_{a}(j\Omega)|^{2}= \frac{1}{1+(\frac{\Omega}{\Omega_{c}})^{2N}}\\
%        (\Omega_{s},\alpha_{s})  &\quad \\
%        \end{aligned}
%        \right.
%      $$
%      $$\mbox{得到：}\quad\quad\quad\quad
%      |H_{a}(j\Omega)|^{2}= \frac{1}{1+(\frac{\Omega}{\Omega_{c}})^{2N}}
...
\subsubsection{基本概念}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[shrink]\frametitle{一、基本概念}%[allowframebreaks]
\begin{enumerate}
  \item [(1)]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[shrink]\frametitle{二、从AF设计DF的基本思想}%[allowframebreaks]
